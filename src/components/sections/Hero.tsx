...
const HeroSection = () => {
  ...
  return (
    ...
    >
      <div className="container mx-auto grid grid-cols-2 px-8 items-center gap-1">
        ...
        <div className="text-left mx-16">
          ...
          <h1
            ref={titleRef}
            className="text-5xl lg:text-7xl font-bold text-primary mb-4 opacity-100"
          >
            Joshua
          </h1>
          ...
          <p
            ref={subtitleRef}
            className="text-xl text-gray-200 mb-8 max-w-2xl opacity-100"
          >
            Make your ideas a reality with our innovative solutions. Transforming complex challenges into elegant digital solutions.
          </p>

          {/* LinkedIn button - tidak berubah */}
          <a 
            href="https://www.linkedin.com/in/joshua-kresna-kusmono-a9a26834b/" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center px-5 py-2 bg-black border-2 border-primary hover:bg-primary rounded-xl hover:border-transparent text-white hover:text-black transition-colors"
          >
